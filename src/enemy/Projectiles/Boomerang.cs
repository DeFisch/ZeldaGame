...
public class Boomerang : IEnemyProjectile
{
    ...
    {
        return new Rectangle((int)location.X, (int)location.Y, (int)(Boomerang_sprites[currentFrame].Width * Globals.scale.X), (int)(Boomerang_sprites[currentFrame].Height * Globals.scale.Y));
    }
